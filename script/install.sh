...
copyPachctl() {
    ...
    if [ "${MACH}" == "Darwin" ] || [ "${MACH}" == "darwin" ]; then
        ...
        cp pachctl_${PACHCTL_VER}_darwin_${ARCH}/pachctl $1
        rm -rf pachctl_${PACHCTL_VER}_darwin_${ARCH} pachctl.zip
        ...
        cp pachctl_${PACHCTL_VER}_linux_${ARCH}/pachctl $1
        rm -rf pachctl_${PACHCTL_VER}_linux_${ARCH} pachctl.tar.gz
    else
